...
open class CheckoutCartAPI {
     ...
     */
    @discardableResult
    open class func checkoutCartByTokenTokenGet(token: String, apiResponseQueue: DispatchQueue = VioletProxyClientAPIAPI.apiResponseQueue, completion: @escaping ((_ data: Order?, _ error: Error?) -> Void)) -> RequestTask {
        return checkoutCartByTokenTokenGetWithRequestBuilder(token: token).execute(apiResponseQueue) { result in
            switch result {
     ...
     */
    open class func checkoutCartByTokenTokenGetWithRequestBuilder(token: String) -> RequestBuilder<Order> {
     ...
     */
    @discardableResult
    open class func checkoutCartCartIdDelete(cartId: Int64, apiResponseQueue: DispatchQueue = VioletProxyClientAPIAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
        return checkoutCartCartIdDeleteWithRequestBuilder(cartId: cartId).execute(apiResponseQueue) { result in
            switch result {
            case .success:
                completion((), nil)
            case let .failure(error):
     ...
     */
    open class func checkoutCartCartIdDeleteWithRequestBuilder(cartId: Int64) -> RequestBuilder<Void> {
     ...
     */
    @discardableResult
    open class func checkoutCartCartIdGet(cartId: Int64, apiResponseQueue: DispatchQueue = VioletProxyClientAPIAPI.apiResponseQueue, completion: @escaping ((_ data: Order?, _ error: Error?) -> Void)) -> RequestTask {
        return checkoutCartCartIdGetWithRequestBuilder(cartId: cartId).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Order> 
     */
    open class func checkoutCartCartIdGetWithRequestBuilder(cartId: Int64) -> RequestBuilder<Order> {
        var localVariablePath = "/checkout/cart/{cart_id}"
        let cartIdPreEscape = "\(APIHelper.mapValueToPathItem(cartId))"
        let cartIdPostEscape = cartIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{cart_id}", with: cartIdPostEscape, options: .literal, range: nil)
     ...
     */
    @discardableResult
    open class func checkoutCartPost(appOrderId: String? = nil, baseCurrency: String? = nil, referralId: String? = nil, cartInitializationRequest: CartInitializationRequest? = nil, apiResponseQueue: DispatchQueue = VioletProxyClientAPIAPI.apiResponseQueue, completion: @escaping ((_ data: Order?, _ error: Error?) -> Void)) -> RequestTask {
        return checkoutCartPostWithRequestBuilder(appOrderId: appOrderId, baseCurrency: baseCurrency, referralId: referralId, cartInitializationRequest: cartInitializationRequest).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Order> 
     */
    open class func checkoutCartPostWithRequestBuilder(appOrderId: String? = nil, baseCurrency: String? = nil, referralId: String? = nil, cartInitializationRequest: CartInitializationRequest? = nil) -> RequestBuilder<Order> {
