...
open class CheckoutCompletionAPI {
     ...
     */
    @discardableResult
    open class func checkoutCartCartIdPriceGet(cartId: Int64, apiResponseQueue: DispatchQueue = VioletProxyClientAPIAPI.apiResponseQueue, completion: @escaping ((_ data: Order?, _ error: Error?) -> Void)) -> RequestTask {
        return checkoutCartCartIdPriceGetWithRequestBuilder(cartId: cartId).execute(apiResponseQueue) { result in
            switch result {
     ...
     */
    open class func checkoutCartCartIdPriceGetWithRequestBuilder(cartId: Int64) -> RequestBuilder<Order> {
     ...
     */
    @discardableResult
    open class func checkoutCartCartIdSubmitPost(cartId: Int64, apiResponseQueue: DispatchQueue = VioletProxyClientAPIAPI.apiResponseQueue, completion: @escaping ((_ data: Order?, _ error: Error?) -> Void)) -> RequestTask {
        return checkoutCartCartIdSubmitPostWithRequestBuilder(cartId: cartId).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Order> 
     */
    open class func checkoutCartCartIdSubmitPostWithRequestBuilder(cartId: Int64) -> RequestBuilder<Order> {
