...
open class CheckoutShippingAPI {
     ...
     */
    @discardableResult
    open class func checkoutCartCartIdShippingAvailableGet(cartId: Int64, apiResponseQueue: DispatchQueue = VioletProxyClientAPIAPI.apiResponseQueue, completion: @escaping ((_ data: [OrderShippingMethodWrapper]?, _ error: Error?) -> Void)) -> RequestTask {
        return checkoutCartCartIdShippingAvailableGetWithRequestBuilder(cartId: cartId).execute(apiResponseQueue) { result in
            switch result {
     ...
     */
    open class func checkoutCartCartIdShippingAvailableGetWithRequestBuilder(cartId: Int64) -> RequestBuilder<[OrderShippingMethodWrapper]> {
        ...
        let localVariableRequestBuilder: RequestBuilder<[OrderShippingMethodWrapper]>.Type = VioletProxyClientAPIAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func checkoutCartCartIdShippingPost(cartId: Int64, priceCart: Bool? = nil, body: [BagShippingMethod]? = nil, apiResponseQueue: DispatchQueue = VioletProxyClientAPIAPI.apiResponseQueue, completion: @escaping ((_ data: Order?, _ error: Error?) -> Void)) -> RequestTask {
        return checkoutCartCartIdShippingPostWithRequestBuilder(cartId: cartId, priceCart: priceCart, body: body).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func checkoutCartCartIdShippingPostWithRequestBuilder(cartId: Int64, priceCart: Bool? = nil, body: [BagShippingMethod]? = nil) -> RequestBuilder<Order> {
     ...
     */
    @discardableResult
    open class func checkoutCartCartIdShippingShippingMethodIdDelete(cartId: Int64, shippingMethodId: Int64, priceCart: Bool? = nil, apiResponseQueue: DispatchQueue = VioletProxyClientAPIAPI.apiResponseQueue, completion: @escaping ((_ data: Order?, _ error: Error?) -> Void)) -> RequestTask {
        return checkoutCartCartIdShippingShippingMethodIdDeleteWithRequestBuilder(cartId: cartId, shippingMethodId: shippingMethodId, priceCart: priceCart).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Order> 
     */
    open class func checkoutCartCartIdShippingShippingMethodIdDeleteWithRequestBuilder(cartId: Int64, shippingMethodId: Int64, priceCart: Bool? = nil) -> RequestBuilder<Order> {
